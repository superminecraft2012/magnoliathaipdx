...
const ALL_ITEMS: GalleryItem[] = [
  { id: 'dish-1',  src: '/menu/1.webp',  alt: 'Yellow curry with chicken, potato, onion, carrot and red bell pepper in coconut curry sauce' },
  { id: 'dish-2',  src: '/menu/2.webp',  alt: 'Garlic tofu topped with crisp fried garlic, served with steamed broccoli and carrots' },
  { id: 'dish-3',  src: '/menu/3.webp',  alt: 'Fried spring rolls served with sweet chilli dipping sauce' },
  { id: 'dish-4',  src: '/menu/4.webp',  alt: 'Chicken larb — minced chicken with red onion, mint, cilantro and toasted rice, with cabbage and cucumber' },
  { id: 'dish-5',  src: '/menu/5.webp',  alt: 'Cashew nut stir-fry with tofu, broccoli, carrot, bell pepper and roasted cashews' },
  { id: 'dish-6',  src: '/menu/6.webp',  alt: 'Pineapple fried rice with tofu, peas, carrot, tomato and cucumber' },
  { id: 'dish-7',  src: '/menu/7.webp',  alt: 'Panang curry with tofu, green beans and red bell pepper in thick coconut curry' },
  { id: 'dish-8',  src: '/menu/8.webp',  alt: 'Pad Thai Duck — rice noodles with crispy roasted duck, bean sprouts, ground peanuts and lime' },
  { id: 'dish-9',  src: '/menu/9.webp',  alt: 'Red curry with tofu, pineapple, bell pepper, broccoli and Thai basil' },
  { id: 'dish-10', src: '/menu/10.webp', alt: 'Wonton soup with shrimp, bean sprouts, spinach and scallions in clear broth' },
  { id: 'dish-11', src: '/menu/11.webp', alt: 'Chicken satay skewers with peanut sauce and cucumber relish' },
  { id: 'dish-12', src: '/menu/12.webp', alt: 'Basil fried rice with tofu, Thai basil, tomato, onion and mushroom' },
